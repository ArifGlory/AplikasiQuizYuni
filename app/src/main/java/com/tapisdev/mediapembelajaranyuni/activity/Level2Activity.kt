...
import com.tapisdev.mediapembelajaranyuni.model.Level2
...
class Level2Activity : BaseActivity() {
    var mDB: DBAdapter? = null
    var listSoal : ArrayList<Level2> = ArrayList<Level2>()
    var listSoalTemp : ArrayList<Level2> = ArrayList<Level2>()

    var TAG_LEVEL2 = "seksi_level2"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listSoal = mDB!!.getSoalLevel2()
        listSoalTemp = mDB!!.getSoalLevel2()
    ...
    fun showDialogAudio(){
        ...
        Log.d(TAG_LEVEL2," "+listSoal.get(currentSoal))
    ...
    fun checkNextOrFinish(){
        //jika sudah mencapai 13 record soal
        if (countNextSoal < 13){
            ...
            if (listSoal.get(currentSoal).status.equals("info")){
                ...
                if(listSoal.get(currentSoal).teks_bacaan.equals("-")){
                    showDialogAudio()
                }
            ...
            SharedVariable.activeSkorLevel2 = SharedVariable.nilaiJawabBenarLevel2 * totalSkor
            //showSuccessMessage("Tes Mendengarkan Selesai !, jawaban benar : "+skorUser)
            Log.d(TAG_LEVEL2,"Tes level 1 Selesai !, hasil skor : "+SharedVariable.activeSkorLevel2)
            val i = Intent(this,ResultActivity::class.java)
            i.putExtra("fromLevel","level2")
            startActivity(i)
        }
    }
    ...
    fun setupSoal(){
        ...
        Log.d(TAG_LEVEL2,"curr soal : "+currentSoal)
        ...
        if (!listSoal.get(currentSoal).status.equals("info")){
            ...
            if (listSoal.get(currentSoal).teks_bacaan.equals("-")){
                ...
                tvInfoSoal.setText(listSoal.get(currentSoal).teks_bacaan)
            }
